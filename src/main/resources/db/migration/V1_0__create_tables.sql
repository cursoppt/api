...
INSERT INTO API.USUARIO (ID_USUARIO, NOME, LOGIN, SENHA, EMAIL, PERMISSOES) VALUES (API.SQ_ID_USUARIO.nextval,'root','root','$2a$10$NaNNu0sdcbDywSwQQ6juIOwTjPW1zkjvWypfeWHsNEaLmhZLNMvXu','root@gmail.com', 'LEITURA_USUARIO,ESCRITA_USUARIO');
INSERT INTO API.USUARIO (ID_USUARIO, NOME, LOGIN, SENHA, EMAIL, PERMISSOES) VALUES (API.SQ_ID_USUARIO.nextval,'teste','teste','$2a$10$NaNNu0sdcbDywSwQQ6juIOwTjPW1zkjvWypfeWHsNEaLmhZLNMvXu','teste@gmail.com', 'LEITURA_USUARIO');